...
,
		"rect" : [ 298.0, 79.0, 785.0, 635.0 ],
		"bgcolor" : [ 0.886275, 0.870588, 0.815686, 1.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 545.0, 90.0, 100.0, 20.0 ],
					"style" : "",
					"varname" : "cvjit_ubu"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "cvtitle.png",
				"bootpath" : "~/Documents/Max 7/Packages/cv.jit_mac/media",
				"type" : "PNG ",
				"implicit" : 1
			}
 ],
